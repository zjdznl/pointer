...
public class SmsApi {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        //修改为您的apikey
        String apikey = "5899db1070757260c21cbe6e8a4c3bd0";
        //修改为您要发送的手机号
        String mobile = "13185470828";
        ...
        //模板发送的调用示例
        System.out.println(SmsApi.tplSendSms(apikey, tpl_id, tpl_value, mobile));
